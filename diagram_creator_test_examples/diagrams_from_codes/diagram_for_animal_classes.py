...
with Diagram("animal classes.py", filename= "./diagram_creator_test_examples/diagrams_from_codes/diagram_for_animal_classes", direction="LR", show=False, graph_attr=graph_attr):
